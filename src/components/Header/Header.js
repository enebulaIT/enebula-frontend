...
const Header = (props) => {
  ...
  return (
    <header
      className={`header js-header-scroll ${
        screenscrolled || megaMenuVisible ? 'header__sticky' : 'header__sticky'
      } ${location.pathname !== '/' ? 'header__inner header__sticky' : ''}`}
    >
        ...
        <div className="nav-container">
          <div className="nav-header right">
            ...
            <button
              ...
              onClick={() => {
                props.setSideMenuVisibility(!props.sideMenuVisibility);
              }}
            >
          ...
          <div className="wrap-core-nav-list right">
            ...
            <ul className="menu core-nav-list">
              ...
              <li
                ...
                onClick={() => {
                  setMegaMenuVisibility(!megaMenuVisible);
                }}
              >
                        ...
                        <div className="megamenu__widget">
                          <div className="megamenu__widget-group">
                            ...
                            >
                              Web Development
                              <span>
                                Frontend, Backend, Full-stack, Static, Ecommerce
                              </span>
                            </Link>
                          </div>
                        </div>
                        ...
                        <div className="megamenu__widget">
                          <div className="megamenu__widget-group">
                            ...
                            >
                              ...
                              <span>
                                Unity 2D/2.5D/3D Games, AR, Single/Multiplayer
                                Games, Online, Gamification
                              </span>
                            </Link>
                          </div>
                        </div>
                        ...
                        <div className="megamenu__widget">
                          <div className="megamenu__widget-group">
                            ...
                            >
                              Security & Audit
                              <span>
                                VAPT, Cyber Forensics, Server Management,
                                Testing
                              </span>
                            </Link>
                          </div>
                        ...
                        <div className="megamenu__widget">
                          <div className="megamenu__widget-group">
                            ...
                            >
                              Digital Marketing
                              <span>
                                SEO, SEM, SMM, Email marketing, Inbound
                                marketing{' '}
                              </span>
                            </Link>
                          </div>
